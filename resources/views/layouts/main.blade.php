...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('img/logoipg.ico') }}" />

    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="{{ asset('modernize/libs/owl.carousel/dist/assets/owl.carousel.min.css') }}">

    <!-- Core Css -->
    <link id="themeColors" rel="stylesheet" href="{{ asset('modernize/css/style.min.css') }}" />
...
<body>
    <!-- Preloader -->
    <div class="preloader">
        <img src="{{ asset('img/logoipg.ico') }}" alt="loader" class="lds-ripple img-fluid" />
    </div>
                ...
                <div class="owl-carousel counter-carousel owl-theme">
                        ...
                        <div class="card border-0 zoom-in bg-light-primary shadow-none">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="../../dist/images/svgs/icon-user-male.svg" width="50" height="50"
                                        class="mb-3" alt="" />
                    ...
                    <div class="item">
                        <div class="card border-0 zoom-in bg-light-info shadow-none">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="../../dist/images/svgs/icon-mailbox.svg" width="50" height="50"
                                        class="mb-3" alt="" />
                    ...
                    <div class="item">
                        <div class="card border-0 zoom-in bg-light-success shadow-none">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="../../dist/images/svgs/icon-speech-bubble.svg" width="50"
                    ...
                    <div class="item">
                        <div class="card border-0 zoom-in bg-light-info shadow-none">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="../../dist/images/svgs/icon-connect.svg" width="50" height="50"
                                        class="mb-3" alt="" />
        ...
        <div class="offcanvas-body p-4">
            <div class="theme-option pb-4">
                ...
                <div class="d-flex align-items-center gap-3 my-3">
                    <a href="javascript:void(0)" onclick="toggleTheme('{{ asset('modernize/css/style.min.css') }}')"
                        class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
                        <i class="ti ti-brightness-up fs-7 text-primary"></i>
                        <span class="text-dark">Light</span>
                    </a>
                    <a href="javascript:void(0)"
                        onclick="toggleTheme('{{ asset('modernize/css/style-dark.min.css') }}')"
                    ...
                    <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('modernize/css/style.min.css') }}')"
                                data-color="blue_theme" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-title="BLUE_THEME">
                                <i
                                    class="ti ti-check text-white d-flex align-items-center justify-content-center fs-5"></i>
                            </a>
                        </li>
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('modernize/css/style-aqua.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('modernize/css/style-purple.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('modernize/css/style-green.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('modernize/css/style-cyan.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('modernize/css/style-orange.min.css') }}')"
    ...
    <script src="{{ asset('modernize/js/datatable/datatable-basic.init.js') }}"></script>

    <!-- sweetalert -->
    <script src="{{ asset('modernize/libs/sweetalert2/dist/sweetalert2.min.js') }}"></script>
    <script src="{{ asset('modernize/js/forms/sweet-alert.init.js') }}"></script>
