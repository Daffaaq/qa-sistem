        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formCreateForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCreateFormLabel">Tambah Dokumen Form Management Representative</h5>
...
@push('scripts')
    <script>
        ...
        $('#formCreateForm').on('submit', function(e) {
            ...
            const actionUrl = `{{ route('management-representative.store-form', ['wi' => '__wiId__']) }}`.replace('__wiId__',
                selectedWiId);
                    ...
                    if (response.success) {
                        ...
                        $.ajax({
                            ...
                            success: function(html) {
                                ...
                                $.get("{{ route('management-representative.count-form') }}", function(res) {
