...
@section('content')
        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="fw-semibold mb-0">Management Representative SOP</h4>
                    <ol class="breadcrumb border border-info px-3 py-2 rounded">
                        <li class="breadcrumb-item">
                            <a href="{{ route('dashboard') }}" class="text-muted">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="active text-primary fw-semibold">Management Representative SOP</span>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="row mb-4 align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div
                                ...
                                <div>
                                    <h5 class="mb-0" id="total-documents-sop-rep">{{ $sopCount }}</h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div
                                ...
                                <div>
                                    <h5 class="mb-0" id="total-documents-wi-rep">{{ $wiCount }}</h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div
                                ...
                                <div>
                                    <h5 class="mb-0" id="total-documents-form-rep">{{ $formCount }}</h5>
    ...
    @include('document-quality-sop.management-representative.modal-preview')
    @include('document-quality-sop.management-representative.modal-create-sop')
    @include('document-quality-sop.management-representative.modal-edit-sop')
    @include('document-quality-sop.management-representative.modal-revisi-sop')
    @include('document-quality-sop.management-representative.modal-create-wi')
    @include('document-quality-sop.management-representative.modal-edit-wi')
    @include('document-quality-sop.management-representative.modal-revisi-wi')
    @include('document-quality-sop.management-representative.modal-create-form')
    @include('document-quality-sop.management-representative.modal-edit-form')
    @include('document-quality-sop.management-representative.modal-revisi-form')
    @include('document-quality-sop.management-representative.modal-show-revisi')
@endsection
...
@push('scripts')
    <script>
        ...
        function filterDocuments() {
            ...
            document.querySelectorAll('#sop-rep-list-container li').forEach(li => {
            ...
            const sopListContainer = document.getElementById('sop-rep-list-container');
    ...
    <script>
        ...
        function refreshAllCounts() {
            $.get("{{ route('management-representative.count-all') }}", function(res) {
        ...
        $(document).on('click', '.btn-delete-sop', function(e) {
            ...
            const url = `{{ route('management-representative.destroy-sop', ['sop' => ':sopId']) }}`.replace(':sopId', id);
        ...
        $(document).on('click', '.btn-delete-wi', function(e) {
            e.preventDefault();
            const id = $(this).data('id');
            const url = `{{ route('management-representative.destroy-wi', ['wi' => ':wiId']) }}`.replace(':wiId', id);
        ...
        $(document).on('click', '.btn-delete-form', function(e) {
            e.preventDefault();
            const id = $(this).data('id');
            const url = `{{ route('management-representative.destroy-form', ['form' => ':formId']) }}`.replace(':formId', id);
