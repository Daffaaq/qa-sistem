            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="Management Representative" readonly>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="edit_keterangan" class="form-control" rows="3"
                            placeholder="Contoh: Dokumen SOP Management Representative untuk pengujian material tahun 2025"></textarea>
...
@push('scripts')
    <script type="module">
        ...
        $(document).on('click', '.btn-edit-sop-rep', function(e) {
            ...
            $.get("{{ route('management-representative.edit-sop', ['sop' => ':sopId']) }}".replace(':sopId', sopId),
                function(data) {
                    ...
                    const updateSopUrl =
                        "{{ route('management-representative.update-sop', ['sop' => ':sopId']) }}".replace(
                            ':sopId', sopId);
