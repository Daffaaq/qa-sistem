...
@push('scripts')
    <script>
        $(document).on('click', '#btnShowAllRevisions', function() {
            ...
            $.get("{{ route('management-representative.revisi-show') }}", function(response) {
        ...
        function renderHistories(histories, docType = 'sop', parentPrefixedId = null) {
            ...
            const baseRoute = {
                sop: "{{ route('management-representative.sop.set-active', ['id' => ':id']) }}",
                wi: "{{ route('management-representative.wi.set-active', ['id' => ':id']) }}",
                form: "{{ route('management-representative.form.set-active', ['id' => ':id']) }}"
            };
