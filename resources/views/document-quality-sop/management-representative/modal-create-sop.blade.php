...
<div class="modal fade" id="modalCreateSOPRep" tabindex="-1" aria-labelledby="modalCreateSOPRepLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('management-representative.store-sop') }}" method="POST" enctype="multipart/form-data"
                id="formCreateSOPRep">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCreateSOPRepLabel">Tambah Dokumen SOP Management Representative
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="category_document" id="category_document_sop_rep"
                            class="form-control" value="Management Representative" readonly>
                        <small class="form-text text-muted">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $.get("{{ route('management-representative.count-sop') }}", function(res) {
