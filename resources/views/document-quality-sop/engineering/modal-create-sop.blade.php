...
<div class="modal fade" id="modalCreateSOPRep" tabindex="-1" aria-labelledby="modalCreateSOPRepLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('engineering.store-sop') }}" method="POST" enctype="multipart/form-data"
                id="formCreateSOPRep">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCreateSOPRepLabel">Tambah Dokumen SOP Engineering
                    </h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">
                            Maksimal 255 karakter. Contoh: "SOP Engineering PT IPG Tahun 2025".
                        </small>
                    </div>
