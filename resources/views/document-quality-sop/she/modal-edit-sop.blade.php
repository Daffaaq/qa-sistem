            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="SHE" readonly>
...
@push('scripts')
    <script type="module">
        ...
        $(document).on('click', '.btn-edit-sop-rep', function(e) {
            ...
            $.get("{{ route('she.edit-sop', ['sop' => ':sopId']) }}".replace(':sopId', sopId),
                function(data) {
                    $('#edit_sop_id').val(sopId);
                    $('#edit_title_document').val(data.title_document);
                    // $('#edit_keterangan').val(data.keterangan);
                    $('#modalEditSOPRep').find('#edit_keterangan').val(data.keterangan);
                    console.log($("#edit_keterangan").length);
                    ...
                    const updateSopUrl =
                        "{{ route('she.update-sop', ['sop' => ':sopId']) }}".replace(
                            ':sopId', sopId);
