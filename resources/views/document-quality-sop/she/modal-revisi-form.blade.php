        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formReviseForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalReviseFormLabel">Revisi Dokumen Form Management SHE</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="revise_keterangan_form_display" class="form-control" rows="3" readonly
                            placeholder="Contoh: Dokumen SOP SHE untuk pengujian material tahun 2025"></textarea>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.btn-revise-form', function(e) {
            ...
            const actionUrl = "{{ route('she.revise-form', ':formId') }}".replace(':formId', formId);
            ...
            $('#modalReviseForm').modal('show').on('shown.bs.modal', function() {
                ...
                $.get("{{ route('she.revisi-form', ':formId') }}".replace(':formId', formId),
                    function(data) {
