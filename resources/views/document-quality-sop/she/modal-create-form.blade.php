        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formCreateForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCreateFormLabel">Tambah Dokumen Form SHE</h5>
...
@push('scripts')
    <script>
        ...
        $('#formCreateForm').on('submit', function(e) {
            ...
            const actionUrl = `{{ route('she.store-form', ['wi' => '__wiId__']) }}`.replace('__wiId__',
                selectedWiId);
                    ...
                    if (response.success) {
                        ...
                        $.ajax({
                            ...
                            success: function(html) {
                                ...
                                $.get("{{ route('she.count-form') }}", function(
                                res) {
