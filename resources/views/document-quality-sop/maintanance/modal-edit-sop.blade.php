            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="Maintanance" readonly>
...
@push('scripts')
    <script type="module">
        ...
        $(document).on('click', '.btn-edit-sop-rep', function(e) {
            ...
            $.get("{{ route('maintanance.edit-sop', ['sop' => ':sopId']) }}".replace(':sopId', sopId),
                function(data) {
                    ...
                    const updateSopUrl =
                        "{{ route('maintanance.update-sop', ['sop' => ':sopId']) }}".replace(
                            ':sopId', sopId);
