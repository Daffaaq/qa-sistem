            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="Human Capital" readonly>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.btn-edit-sop-rep', function(e) {
            ...
            $.get("{{ route('human-capital.edit-sop', ['sop' => ':sopId']) }}".replace(':sopId', sopId),
                function(data) {
                    ...
                    const updateSopUrl =
                        "{{ route('human-capital.update-sop', ['sop' => ':sopId']) }}".replace(
                            ':sopId', sopId);
