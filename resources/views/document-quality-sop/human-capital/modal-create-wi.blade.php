        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formCreateWI">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCreateWILabel">Tambah Dokumen WI Human Capital</h5>
...
@push('scripts')
    <script>
        ...
        $('#formCreateWI').on('submit', function(e) {
            ...
            const actionUrl = `{{ route('human-capital.store-wi', ['sop' => '__sopId__']) }}`.replace('__sopId__',
                selectedSopId);
            Swal.fire({
