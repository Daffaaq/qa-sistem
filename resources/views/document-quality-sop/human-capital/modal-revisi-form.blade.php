        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formReviseForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalReviseFormLabel">Revisi Dokumen Form Management Representative</h5>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.btn-revise-form', function(e) {
            ...
            const actionUrl = "{{ route('human-capital.revise-form', ':formId') }}".replace(':formId', formId);
            ...
            $('#modalReviseForm').modal('show').on('shown.bs.modal', function() {
                ...
                $.get("{{ route('human-capital.revisi-form', ':formId') }}".replace(':formId', formId),
                    function(data) {
