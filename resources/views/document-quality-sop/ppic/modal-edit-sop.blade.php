<!-- Modal Edit SOP -->
<div class="modal fade" id="modalEditSOPPPIC" tabindex="-1" aria-labelledby="modalEditSOPLabel" aria-hidden="true">
            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="PPIC" readonly>
...
@push('scripts')
    <script type="module">
        ...
        window.BASE_URL = "{{ asset('documents/ppic') }}"; // Set base URL dynamically
        ...
        $(document).on('click', '.btn-edit-sop-ppic', function(e) {
            e.preventDefault();
            ...
            $.get("{{ route('ppic.edit-sop', ['sop' => ':sopId']) }}".replace(':sopId', sopId),
                function(data) {
                    ...
                    const updateSopUrl =
                        "{{ route('ppic.update-sop', ['sop' => ':sopId']) }}".replace(
                            ':sopId', sopId);
                    $('#formEditSOP').attr('action', updateSopUrl);

                    // Show modal
                    $('#modalEditSOPPPIC').modal('show');
                });
        ...
        $('#modalEditSOPPPIC').on('hidden.bs.modal', function() {
