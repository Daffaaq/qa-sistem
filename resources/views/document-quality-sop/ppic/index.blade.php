...
@section('content')
        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="fw-semibold mb-0">PPIC SOP</h4>
                    <ol class="breadcrumb border border-info px-3 py-2 rounded">
                        <li class="breadcrumb-item">
                            <a href="{{ route('dashboard') }}" class="text-muted">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="active text-primary fw-semibold">PPIC SOP</span>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    @include('document-quality-sop.ppic.modal-preview')
    @include('document-quality-sop.ppic.modal-create-sop')
    @include('document-quality-sop.ppic.modal-edit-sop')
    @include('document-quality-sop.ppic.modal-revisi-sop')
    @include('document-quality-sop.ppic.modal-create-wi')
    @include('document-quality-sop.ppic.modal-edit-wi')
    @include('document-quality-sop.ppic.modal-revisi-wi')
    @include('document-quality-sop.ppic.modal-create-form')
    @include('document-quality-sop.ppic.modal-edit-form')
    @include('document-quality-sop.ppic.modal-revisi-form')
    @include('document-quality-sop.ppic.modal-show-revisi')
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        function refreshAllCounts() {
            $.get("{{ route('ppic.count-all') }}", function(res) {
        ...
        $(document).on('click', '.btn-delete-sop', function(e) {
            ...
            const url = `{{ route('ppic.destroy-sop', ['sop' => ':sopId']) }}`.replace(
                ':sopId', id);
        ...
        $(document).on('click', '.btn-delete-wi', function(e) {
            e.preventDefault();
            const id = $(this).data('id');
            const url = `{{ route('ppic.destroy-wi', ['wi' => ':wiId']) }}`.replace(':wiId',
                id);
        ...
        $(document).on('click', '.btn-delete-form', function(e) {
            e.preventDefault();
            const id = $(this).data('id');
            const url = `{{ route('ppic.destroy-form', ['form' => ':formId']) }}`.replace(
                ':formId', id);
