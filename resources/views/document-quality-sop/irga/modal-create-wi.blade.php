        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formCreateWI">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCreateWILabel">Tambah Dokumen WI IRGA</h5>
...
@push('scripts')
    <script>
        ...
        $('#formCreateWI').on('submit', function(e) {
            ...
            const actionUrl = `{{ route('irga.store-wi', ['sop' => '__sopId__']) }}`.replace('__sopId__',
                selectedSopId);
            Swal.fire({
                    ...
                    if (response.success) {
                        ...
                        $.ajax({
                            ...
                            success: function(html) {
                                ...
                                $.get("{{ route('irga.count-wi') }}", function(res) {
