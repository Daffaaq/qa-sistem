<ul>
            ...
            <div class="doc-item sop toggle-node" tabindex="0" role="button" aria-expanded="false">
                ...
                <div class="action-buttons">
                    @if (Auth::user() && Auth::user()->role === 'superadmin')
                        <a href="#" class="btn btn-sm btn-primary me-1 btn-edit-sop-rep"
    ...
    <li>
        @if (Auth::user() && Auth::user()->role === 'superadmin')
            <button class="btn btn-sm btn-success btn-add-human-capital" data-bs-toggle="modal"
                data-bs-target="#modalCreateSOPRep">
