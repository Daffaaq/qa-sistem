        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formReviseSOP">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalReviseSOPLabel">Revisi Dokumen SOP QC</h5>
                ...
                <div class="modal-body">
                    ...
                    <!-- TAMBAH INI SETELAH "Upload Dokumen Revisi" -->
                    <div class="mb-3">
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.btn-revise-sop', function(e) {
            ...
            const actionUrl = `{{ route('qa-qc.revise-sop', ':id') }}`.replace(':id', sopId);
            $('#formReviseSOP').attr('action', actionUrl);

            // Ambil data judul & file aktif dari server
            $.get("{{ route('qa-qc.revisi-sop', ':id') }}".replace(':id', sopId), function(data) {
