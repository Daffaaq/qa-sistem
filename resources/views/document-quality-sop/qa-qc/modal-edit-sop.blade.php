<!-- Modal Edit SOP -->
<div class="modal fade" id="modalEditSOP" tabindex="-1" aria-labelledby="modalEditSOPLabel" aria-hidden="true">
            ...
            <form method="POST" enctype="multipart/form-data" id="formEditSOP">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="QA QC" readonly>
...
@push('scripts')
    <script>
        window.BASE_URL = "{{ asset('documents/qa-qc') }}"; // Set base URL dynamically
        ...
        $(document).on('click', '.btn-edit-sop', function(e) {
            e.preventDefault();
            ...
            $.get("{{ route('qa-qc.edit-sop', ['sop' => ':sopId']) }}".replace(':sopId', sopId), function(data) {
                ...
                const updateSopUrl = "{{ route('qa-qc.update-sop', ['sop' => ':sopId']) }}".replace(
                    ':sopId', sopId);
                $('#formEditSOP').attr('action', updateSopUrl);

                // Show modal
                $('#modalEditSOP').modal('show');
            });
        ...
        $('#modalEditSOP').on('hidden.bs.modal', function() {
