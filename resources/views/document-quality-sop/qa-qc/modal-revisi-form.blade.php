        ...
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" id="formReviseForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalReviseFormLabel">Revisi Dokumen Form QC</h5>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.btn-revise-form', function(e) {
            ...
            const actionUrl = "{{ route('qa-qc.revise-form', ':formId') }}".replace(':formId', formId);
            ...
            $('#modalReviseForm').modal('show').on('shown.bs.modal', function() {
                ...
                $.get("{{ route('qa-qc.revisi-form', ':formId') }}".replace(':formId', formId),
                    function(data) {
