<!-- Modal Riwayat + Preview (SQAM Supplier) -->
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Riwayat Revisi Dokumen SQAM Supplier</h5>
    ...
    <script type="module">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#btnShowAllRevisions', function() {
                ...
                const route = "{{ route('sqam-supplier.revisi-show') }}";
            ...
            $(document).on('click', '.btn-set-active', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.post("{{ route('sqam-supplier.set-active-revision', '') }}/" +
                        historyId, {
                            _token: '{{ csrf_token() }}',
